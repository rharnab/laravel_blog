                ...
                <div class="card">
                    ...
                    <div class="body">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="post" name="title" class="form-control" placeholder="add title">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="form-line">
                             ...
                             <div class="form-group">
                                <input type="checkbox" name="status" id="publish" value="1">
             ...
             <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                            ...
                            <a href="{{ url('admin/post')}}" type="button" class="btn btn-danger m-t-15 waves-effect">Back</a>
